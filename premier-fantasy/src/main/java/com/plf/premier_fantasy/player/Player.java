package com.plf.premier_fantasy.player;
...
public class Player {
    ...
    public String toString() {
        return "Player [name=" + name + ", nation=" + nation + ", pos=" + pos + ", age=" + age + ", mp=" + mp
                + ", starts=" + starts + ", min=" + min + ", gls=" + gls + ", ast=" + ast + ", pk=" + pk + ", crdy="
                + crdy + ", crdr=" + crdr + ", xg=" + xg + ", xag=" + xag + ", team=" + team + "]";
    }
